<script lang="ts">
	...
	let languageMenuDropdown: HTMLElement;
	...
	onMount(() => {
		const closeList = (event: MouseEvent) => {
			...
			if (languageMenuDropdown && !languageMenuDropdown.contains(event.target as Node)) {
				isOpenlanguageMenuDropdown.set(false);
			}
	...
	function togglelanguageMenuDropdown() {
		isOpenlanguageMenuDropdown.update((value) => !value);
	}
...
>
	...
	<div class="navigation__burger" class:active={$isOpenBurger}>
		...
		<ul class="navigation__list">
			<li class="navigation__item"><a href="/" title="Перейти до секції">Про нас</a></li>
			<li class="navigation__item"><a href="/">Вимоги</a></li>
			<li class="navigation__item">
				<a href="/" title="Перейти до секції">Схема нашої співпраці</a>
			</li>
			<li class="navigation__item">
				<a href="/" title="Перейти до секції">Заробітки</a>
			</li>
		</ul>
		<hr class="line" />
