<script lang="ts">
	...
	import Language_Swicther from '$lib/components/header/Language_Swicther.svelte';
	...
	function toggleBurger() {
		isOpenBurger.update((value) => !value);
	}
	...
	$: navList = [
		{ href: '/#why', title: $t('main_navigation.title'), text: $t('main_navigation.about_us') },
		{
			href: '/#requirements',
			title: $t('main_navigation.title'),
			text: $t('main_navigation.requirements')
		},
...
<nav class:sticky bind:this={nav}>
	<div
		bind:this={burger}
		class="flex rounded-full bg-white px-5 py-[23px] shadow-lg bs:w-[280px] sm:w-[320px] md:w-[370px] lg:w-[710px] xl:w-[920px] 2xl:w-[1280px] 2xl:px-10 2xl:py-6"
	>
		<Logo />
		...
		<ul class="flex items-center gap-5 text-sm lg:ml-16">
			...
			<div class="ml-10 bs:hidden lg:flex 2xl:ml-0">
				<Language_Swicther />
			</div>
		</ul>
		...
		<button class="hamburger-menu-button ml-auto lg:ml-10 2xl:hidden" on:click={toggleBurger}>
			...
			>
				<path
					d="M20.3846 1C20.7245 1 21 1.27552 21 1.61539C21 1.95525 20.7245 2.23077 20.3846 2.23077L1.61538 2.23077C1.27552 2.23077 1 1.95525 1 1.61538C1 1.27552 1.27552 1 1.61538 1L20.3846 1Z"
					fill="#461DBA"
				></path>
				<path
					d="M20.3846 8.38462C20.7245 8.38462 21 8.66013 21 9C21 9.33987 20.7245 9.61539 20.3846 9.61539H1.61538C1.27552 9.61539 1 9.33987 1 9C1 8.66013 1.27552 8.38461 1.61539 8.38461L20.3846 8.38462Z"
					fill="#461DBA"
				></path>
				<path
					d="M20.3846 15.7692C20.7245 15.7692 21 16.0447 21 16.3846C21 16.7245 20.7245 17 20.3846 17L1.61538 17C1.27552 17 1 16.7245 1 16.3846C1 16.0447 1.27552 15.7692 1.61538 15.7692L20.3846 15.7692Z"
					fill="#461DBA"
				></path>
				<path
					d="M20.3846 1C20.7245 1 21 1.27552 21 1.61539C21 1.95525 20.7245 2.23077 20.3846 2.23077L1.61538 2.23077C1.27552 2.23077 1 1.95525 1 1.61538C1 1.27552 1.27552 1 1.61538 1L20.3846 1Z"
		...
		<div class="navigation__burger" class:active={$isOpenBurger}>
				...
				<button on:click={closeList} class="btn__close">
					...
					>
						<g clip-path="url(#clip0_1_659)">
							<path
								d="M11.2878 -1.45702C11.5132 -1.68244 11.8787 -1.68244 12.1042 -1.45702C12.3296 -1.23159 12.3296 -0.866112 12.1042 -0.640689L-0.140744 11.6042C-0.366167 11.8296 -0.731648 11.8296 -0.957071 11.6042C-1.18249 11.3788 -1.18249 11.0133 -0.957071 10.7879L11.2878 -1.45702Z"
								fill="#461DBA"
							></path>
							<path
								d="M16.1858 3.44094C16.4112 3.21552 16.7767 3.21552 17.0021 3.44094C17.2275 3.66637 17.2275 4.03185 17.0021 4.25727L4.75721 16.5022C4.53179 16.7276 4.16631 16.7276 3.94089 16.5022C3.71547 16.2767 3.71547 15.9113 3.94089 15.6858L16.1858 3.44094Z"
								fill="#461DBA"
							></path>
							<path
								d="M21.0837 8.3389C21.3092 8.11348 21.6747 8.11348 21.9001 8.3389C22.1255 8.56432 22.1255 8.92981 21.9001 9.15523L9.65517 21.4001C9.42975 21.6255 9.06427 21.6255 8.83885 21.4001C8.61343 21.1747 8.61343 20.8092 8.83885 20.5838L21.0837 8.3389Z"
								fill="#461DBA"
							></path>
							<path
								d="M11.2878 -1.45702C11.5132 -1.68244 11.8787 -1.68244 12.1042 -1.45702C12.3296 -1.23159 12.3296 -0.866112 12.1042 -0.640689L-0.140744 11.6042C-0.366167 11.8296 -0.731648 11.8296 -0.957071 11.6042C-1.18249 11.3788 -1.18249 11.0133 -0.957071 10.7879L11.2878 -1.45702Z"
						...
						<g clip-path="url(#clip1_1_659)">
							<path
								d="M10.0637 -1.45702C9.83831 -1.68244 9.47283 -1.68244 9.24741 -1.45702C9.02199 -1.23159 9.02199 -0.866112 9.24741 -0.640689L21.4923 11.6042C21.7177 11.8296 22.0832 11.8296 22.3086 11.6042C22.5341 11.3788 22.5341 11.0133 22.3086 10.7879L10.0637 -1.45702Z"
								fill="#461DBA"
							></path>
							<path
								d="M5.16578 3.44094C4.94035 3.21552 4.57487 3.21552 4.34945 3.44094C4.12403 3.66637 4.12403 4.03185 4.34945 4.25727L16.5943 16.5022C16.8198 16.7276 17.1853 16.7276 17.4107 16.5022C17.6361 16.2767 17.6361 15.9113 17.4107 15.6858L5.16578 3.44094Z"
								fill="#461DBA"
							></path>
							<path
								d="M0.267817 8.3389C0.0423936 8.11348 -0.323088 8.11348 -0.54851 8.3389C-0.773932 8.56432 -0.773933 8.92981 -0.54851 9.15523L11.6964 21.4001C11.9218 21.6255 12.2873 21.6255 12.5127 21.4001C12.7381 21.1747 12.7381 20.8092 12.5127 20.5838L0.267817 8.3389Z"
								fill="#461DBA"
							></path>
							<path
								d="M10.0637 -1.45702C9.83831 -1.68244 9.47283 -1.68244 9.24741 -1.45702C9.02199 -1.23159 9.02199 -0.866112 9.24741 -0.640689L21.4923 11.6042C21.7177 11.8296 22.0832 11.8296 22.3086 11.6042C22.5341 11.3788 22.5341 11.0133 22.3086 10.7879L10.0637 -1.45702Z"
						...
						<defs>
							<clipPath id="clip0_1_659">
								<rect
									...
									height="7.50399"
									fill="white"
									transform="translate(0.675781 14.8696) rotate(-45)"
								></rect>
							</clipPath>
							<clipPath id="clip1_1_659">
								<rect
									...
									height="7.50399"
									fill="white"
									transform="matrix(-0.707107 -0.707107 -0.707107 0.707107 20.6758 14.8696)"
								></rect>
							</clipPath>
						</defs>
					</svg>
			...
			<ul class="navigation__list">
				{#each navList as list}
					<li class="navigation__item">
						<a
							href={list.href}
							on:click={(event) => scrollToSection(event, list.href)}
							title={list.title}>{list.text}</a
						>
					</li>
				{/each}
			</ul>
