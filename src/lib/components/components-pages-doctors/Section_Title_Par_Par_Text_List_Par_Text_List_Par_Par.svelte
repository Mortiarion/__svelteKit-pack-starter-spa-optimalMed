<script lang="ts">
	...
	import type { Section_Title_Par_Par_Text_List_Par_Text_List_Par_Par_Type } from '$lib/types';
	export let data: Section_Title_Par_Par_Text_List_Par_Text_List_Par_Par_Type;
</script>
...
<Section>
	<Container classes="px-2.5 lg:px-[50px] 2xl:px-0 2xl:max-w-3xl">
		<div class="flex flex-col gap-5 2xl:mb-[60px]">
			...
			<Paragraph>
				{data.paragraph__four}
			</Paragraph>
			<Paragraph>
				{data.paragraph__five}
			</Paragraph>
		</div>
	</Container>
</Section>
